export const quizData = [
...

  {
    ...
    options: [
      ...
      "La temperatura en el aula es de 35º Celsius.",
...

  {
    ...
    options: [
      "Muy pocas veces las personas estará empenadas en no reconocer las fallas que poseen IOS argumentos.",
  ...
  {
    question: "Cuál sería la figura que completa la serie?",
    options: ["A ", "B", "C", "D"],
    answer: 2,
    imagen: "/31.png",
  },
  ...
  {
    question:
      "De los cuatro grupos de letras que se colocan a continuación, uno sigue una de agrupación distinta a la de los demás. ¿ Cuál es?",
    options: ["qp ", "db", "oo", "hi"],
    answer: 2,
  },
  ...
  {
    question:
      "Siga con la vista el trazado de figura angular sobre la red de puntos rojos e indiquepor cuál punto rojo no estaría uno de los vértices del trazado de la figura.",
    options: ["A", "B", "C", "D"],
    answer: 3,
    imagen: "/35.png",
  },
  ...
  {
    question:
      "La primera figura representa un papel rectángulo doblado con forma triangular, si lo desdoblamos siguiendo el sentido de la flecha, ¿cuál de las cuatro opciones sería lafigura que obtendríamos?",
    options: ["A", "B", "C", "D"],
    answer: 1,
  ...
  {
    question:
      "Su tarea consiste en llenar la figura blanca de la izquierda, con tres figuras de la derecha. ¿ Cuál de ellas no sería utilizada? / donde hay varias figuras y al final hay un cuadrado medio-virado",
    options: ["A", "B", "C", "D"],
    answer: 3,
    imagen: "/44.png",
  },
