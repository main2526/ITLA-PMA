          ...
          <div className="mb-4 flex justify-center">
            <div className="relative w-full flex justify-center">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-slate-900/70 rounded-2xl shadow-2xl border-2 border-cyan-400/40 w-full max-w-xs sm:max-w-md md:max-w-lg h-full" style={{zIndex:1}}></div>
              </div>
              ...
              <Image
                ...
                width={320}
                height={180}
                className="relative z-10 w-full max-w-xs sm:max-w-md md:max-w-lg rounded-2xl object-contain shadow-xl border-4 border-cyan-400 cursor-pointer"
                style={{background: 'rgba(30,41,59,0.7)', padding: '0.5rem'}}
            ...
            <AnimatePresence>
              {showImagePopup && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-3 sm:p-6"
                ...
                >
                  <motion.div
                    ...
                    transition={{ type: 'spring', stiffness: 300, damping: 30 }}
                    className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl p-2 sm:p-4 flex flex-col items-center border-2 border-cyan-400/50 max-w-full"
                    onClick={e => e.stopPropagation()}
                  >
                    ...
                    <Image
                      ...
                      width={800}
                      height={600}
                      className="rounded-2xl object-contain shadow-xl border-4 border-cyan-400 max-w-full max-h-[80vh] bg-slate-900"
                      style={{background: 'rgba(30,41,59,0.7)', padding: '0.5rem'}}
                    />
                  </motion.div>
                </motion.div>
